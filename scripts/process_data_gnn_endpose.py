...
def main():
    ...
    # 使用绝对路径指向 /mnt/4T/RoboTwin/data/
    script_dir = os.path.dirname(os.path.abspath(__file__))  # /mnt/4T/RoboTwin/policy/DP3/scripts
    dp3_dir = os.path.dirname(script_dir)  # /mnt/4T/RoboTwin/policy/DP3
    policy_dir = os.path.dirname(dp3_dir)  # /mnt/4T/RoboTwin/policy
    robotwin_root = os.path.dirname(policy_dir)  # /mnt/4T/RoboTwin
    load_dir = os.path.join(robotwin_root, "data", task_name, task_config)
    save_dir = os.path.join(script_dir, f"data/{task_name}-{task_config}-{num}-gnn-endpose.zarr")
